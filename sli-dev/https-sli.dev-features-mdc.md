...
URL Source: http://sli.dev/features/mdc
...
[Skip to content](http://sli.dev/features/mdc#VPContent)

[![Image 1](http://sli.dev/logo.svg)Slidev[New Docs!](http://sli.dev/features/mdc)](http://sli.dev/)
...
[简体中文](https://cn.sli.dev/features/mdc)

[日本語](https://ja.sli.dev/features/mdc)
...
[Syntax](http://sli.dev/features/#tags=syntax)[Styling](http://sli.dev/features/#tags=styling)

 Since 

[v0.43.0](https://github.com/slidevjs/slidev/releases/tag/v0.43.0)

On this page

Are you an LLM? You can read better optimized documentation at /features/mdc.md for this page in Markdown format

MDC Syntax [​](http://sli.dev/features/mdc#mdc-syntax)
======================================================
...
[Suggest changes to this page](https://github.com/slidevjs/slidev/edit/main/docs/features/mdc.md)
