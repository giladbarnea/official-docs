...
URL Source: http://sli.dev/features/global-layers

Markdown Content:
Global Layers [​](http://sli.dev/features/global-layers#global-layers)
----------------------------------------------------------------------
...
Layers relationship [​](http://sli.dev/features/global-layers#layers-relationship)
----------------------------------------------------------------------------------
...
Example [​](http://sli.dev/features/global-layers#example)
----------------------------------------------------------
...
To enable it conditionally, you can use the 📖 Global Context
