...
URL Source: http://sli.dev/features/transform-component

Markdown Content:
The Transform Component | Slidev

===============

[Skip to content](http://sli.dev/features/transform-component#VPContent)

[![Image 1](http://sli.dev/logo.svg)Slidev[New Docs!](http://sli.dev/features/transform-component)](http://sli.dev/)
...
[简体中文](https://cn.sli.dev/features/transform-component)

[日本語](https://ja.sli.dev/features/transform-component)
...
[✨ Slide Canvas Size](http://sli.dev/features/canvas-size)

[✨ Zoom Slides](http://sli.dev/features/zoom-slide)

 Tags 

[Layout](http://sli.dev/features/#tags=layout)

On this page

Are you an LLM? You can read better optimized documentation at /features/transform-component.md for this page in Markdown format

The `Transform` Component [​](http://sli.dev/features/transform-component#the-transform-component)
==================================================================================================
...
[✨ Slide Canvas Size [Layout](http://sli.dev/features/#tags=layout) Set the size for all your slides.](http://sli.dev/features/canvas-size)
To scale several slides in your presentation, you can use the `zoom` option:

✨ Zoom Slides

[✨ Zoom Slides [Layout](http://sli.dev/features/#tags=layout) Zoom the content of a slide to a specific scale.](http://sli.dev/features/zoom-slide)

[Suggest changes to this page](https://github.com/slidevjs/slidev/edit/main/docs/features/transform-component.md)
