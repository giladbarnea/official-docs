Title: MCP - POML Documentation

URL Source: http://microsoft.github.io/poml/stable/python/integration/mcp

Markdown Content:
MCP (Model Context Protocol) Integration[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#mcp-model-context-protocol-integration "Permanent link")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Estimated time to read: 4 minutes_
...
How MCP Works[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#how-mcp-works "Permanent link")
----------------------------------------------------------------------------------------------------------------
...
Installation[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#installation "Permanent link")
--------------------------------------------------------------------------------------------------------------
...
Dynamic Tools with MCP[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#dynamic-tools-with-mcp "Permanent link")
----------------------------------------------------------------------------------------------------------------------------------
...
### POML Template for Dynamic Tools[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#poml-template-for-dynamic-tools "Permanent link")
...
Complete Example with MCP Server[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#complete-example-with-mcp-server "Permanent link")
------------------------------------------------------------------------------------------------------------------------------------------------------

Here's a complete example using a public MCP demo server for dice rolling.

### 1. Tool Discovery and Conversion[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#1-tool-discovery-and-conversion "Permanent link")
...
### 2. Process Tool Calls[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#2-process-tool-calls "Permanent link")
...
### 3. Main Conversation Loop[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#3-main-conversation-loop "Permanent link")
...
### 4. Complete Integration[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#4-complete-integration "Permanent link")
...
Comparison with Direct MCP Usage[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#comparison-with-direct-mcp-usage "Permanent link")
------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Without POML (Direct Approach)[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#without-poml-direct-approach "Permanent link")
...
### With POML (Structured Approach)[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#with-poml-structured-approach "Permanent link")
...
Future Native Support[¶](https://microsoft.github.io/poml/stable/python/integration/mcp/#future-native-support "Permanent link")
--------------------------------------------------------------------------------------------------------------------------------
