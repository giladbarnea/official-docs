Title: OpenAI - POML Documentation

URL Source: http://microsoft.github.io/poml/stable/python/integration/openai

Markdown Content:
OpenAI Integration[¶](https://microsoft.github.io/poml/stable/python/integration/openai/#openai-integration "Permanent link")
-----------------------------------------------------------------------------------------------------------------------------
...
Basic Usage[¶](https://microsoft.github.io/poml/stable/python/integration/openai/#basic-usage "Permanent link")
---------------------------------------------------------------------------------------------------------------
...
Getting Chat Completion Messages[¶](https://microsoft.github.io/poml/stable/python/integration/openai/#getting-chat-completion-messages "Permanent link")
---------------------------------------------------------------------------------------------------------------------------------------------------------
...
Runtime Parameters[¶](https://microsoft.github.io/poml/stable/python/integration/openai/#runtime-parameters "Permanent link")
-----------------------------------------------------------------------------------------------------------------------------
...
Response Format (Structured Output)[¶](https://microsoft.github.io/poml/stable/python/integration/openai/#response-format-structured-output "Permanent link")
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Tool Calls[¶](https://microsoft.github.io/poml/stable/python/integration/openai/#tool-calls "Permanent link")
-------------------------------------------------------------------------------------------------------------
