...
Travel Expense Agent - Part 1: Building a Complete AI Workflow[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#travel-expense-agent-part-1-building-a-complete-ai-workflow "Permanent link")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

_Estimated time to read: 9 minutes_

Welcome to the Travel Expense Agent tutorial! This guide builds on what you learned in the [quickstart](https://microsoft.github.io/poml/stable/tutorial/quickstart/) and shows you how to create a sophisticated AI application that processes real business documents. We'll build an intelligent expense processing system that extracts data from receipts, validates against company policies, and generates automated responses.

What We're Building[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#what-were-building "Permanent link")
---------------------------------------------------------------------------------------------------------------------------

Our travel expense agent handles the complete workflow of expense processing. When an employee submits expense documents, the system needs to extract structured data, check compliance against company policies, and respond with either approval or specific corrections needed. This is a perfect example of how POML, Python and VS Code work together to solve complex, multi-step business problems. We will focus on the Python workflow in this part, and cover debugging with the VS Code extension in [part 2](https://microsoft.github.io/poml/stable/tutorial/expense_part2/).
...
Prerequisites and Setup[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#prerequisites-and-setup "Permanent link")
------------------------------------------------------------------------------------------------------------------------------------
...
Understanding POML's Python Integration[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#understanding-pomls-python-integration "Permanent link")
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Step 2: Identifying Relevant Policy Rules[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#step-2-identifying-relevant-policy-rules "Permanent link")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Step 3: Checking Compliance Against Rules[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#step-3-checking-compliance-against-rules "Permanent link")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Step 4: Generating Automated Email Responses[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#step-4-generating-automated-email-responses "Permanent link")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Running the Complete Example[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#running-the-complete-example "Permanent link")
----------------------------------------------------------------------------------------------------------------------------------------------

To see the full system in action, the full prompt files are available at:

*   [Document extraction](https://github.com/microsoft/poml/tree/da535a7c5a36b10479caca10ea9df2466123f7d9/examples/203_expense_extract_document.poml)
*   [Rule extraction](https://github.com/microsoft/poml/tree/da535a7c5a36b10479caca10ea9df2466123f7d9/examples/204_expense_extract_rules.poml)
*   [Compliance checking](https://github.com/microsoft/poml/tree/da535a7c5a36b10479caca10ea9df2466123f7d9/examples/205_expense_check_compliance.poml)
*   [Email generation](https://github.com/microsoft/poml/tree/da535a7c5a36b10479caca10ea9df2466123f7d9/examples/206_expense_send_email.poml)

The full Python implementation is available at [travel expense agent](https://github.com/microsoft/poml/tree/da535a7c5a36b10479caca10ea9df2466123f7d9/examples/404_travel_expense_agent.py). You can run it by:
...
Next Step[¶](https://microsoft.github.io/poml/stable/tutorial/expense_part1/#next-step "Permanent link")
--------------------------------------------------------------------------------------------------------

*   Try the example file [404_travel_expense_agent.py](https://github.com/microsoft/poml/tree/da535a7c5a36b10479caca10ea9df2466123f7d9/examples/404_travel_expense_agent.py).
*   Explore different options with `syntax`.
*   Go to [part 2](https://microsoft.github.io/poml/stable/tutorial/expense_part2/) to learn how to debug and optimize your prompts using the VS Code extension.