Title: LangChain - POML Documentation

URL Source: http://microsoft.github.io/poml/stable/python/integration/langchain

Published Time: Sat, 20 Sep 2025 06:54:30 GMT

Markdown Content:
LangChain Integration[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#langchain-integration "Permanent link")
--------------------------------------------------------------------------------------------------------------------------------------
...
Installation[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#installation "Permanent link")
--------------------------------------------------------------------------------------------------------------------
...
Basic Usage[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#basic-usage "Permanent link")
------------------------------------------------------------------------------------------------------------------
...
Speaker Mode vs Non-Speaker Mode[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#speaker-mode-vs-non-speaker-mode "Permanent link")
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
POML vs f-string, Jinja, and Other Templates[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#poml-vs-f-string-jinja-and-other-templates "Permanent link")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Template Syntax and Capabilities[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#template-syntax-and-capabilities "Permanent link")
...
### Rich Content and File Inclusion[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#rich-content-and-file-inclusion "Permanent link")
...
### Structured Tags to Organize Few-shot Examples[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#structured-tags-to-organize-few-shot-examples "Permanent link")
...
### Support for Conversational Formats[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#support-for-conversational-formats "Permanent link")
...
Future Integrations[¶](https://microsoft.github.io/poml/stable/python/integration/langchain/#future-integrations "Permanent link")
----------------------------------------------------------------------------------------------------------------------------------
