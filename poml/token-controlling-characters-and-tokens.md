...
Controlling Characters and Tokens[¶](https://microsoft.github.io/poml/stable/language/token/#controlling-characters-and-tokens "Permanent link")
------------------------------------------------------------------------------------------------------------------------------------------------
...
### Character and Token Limits[¶](https://microsoft.github.io/poml/stable/language/token/#character-and-token-limits "Permanent link")
...
### Priority-Based Truncation[¶](https://microsoft.github.io/poml/stable/language/token/#priority-based-truncation "Permanent link")
...
### Combining Limits and Priority[¶](https://microsoft.github.io/poml/stable/language/token/#combining-limits-and-priority "Permanent link")
