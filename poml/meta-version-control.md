# Meta
_Estimated time to read: 7 minutes_
...
### Basic Usage[¶](https://microsoft.github.io/poml/stable/language/meta/#basic-usage "Permanent link")
...
### Meta Element Usage[¶](https://microsoft.github.io/poml/stable/language/meta/#meta-element-usage "Permanent link")

Meta elements are used for general document configuration: - Version control (`minVersion`, `maxVersion`) - Component management (`components`)

Version Control[¶](https://microsoft.github.io/poml/stable/language/meta/#version-control "Permanent link")
-----------------------------------------------------------------------------------------------------------
...
Component Control[¶](https://microsoft.github.io/poml/stable/language/meta/#component-control "Permanent link")
---------------------------------------------------------------------------------------------------------------
...
### Disabling Components[¶](https://microsoft.github.io/poml/stable/language/meta/#disabling-components "Permanent link")
...
### Re-enabling Components[¶](https://microsoft.github.io/poml/stable/language/meta/#re-enabling-components "Permanent link")
...
### Stylesheet[¶](https://microsoft.github.io/poml/stable/language/meta/#stylesheet "Permanent link")
...
#### ClassName Attribute[¶](https://microsoft.github.io/poml/stable/language/meta/#classname-attribute "Permanent link")
...
### Response Schema[¶](https://microsoft.github.io/poml/stable/language/meta/#response-schema "Permanent link")
...
#### JSON Schema Format[¶](https://microsoft.github.io/poml/stable/language/meta/#json-schema-format "Permanent link")
...
#### Expression Format[¶](https://microsoft.github.io/poml/stable/language/meta/#expression-format "Permanent link")
...
When `parser` is omitted, POML auto-detects the format: - If the content starts with `{`, it's treated as JSON - Otherwise, it's treated as an expression

#### Expression Evaluation in Schemas[¶](https://microsoft.github.io/poml/stable/language/meta/#expression-evaluation-in-schemas "Permanent link")

#### JSON Schema with Template Expressions[¶](https://microsoft.github.io/poml/stable/language/meta/#json-schema-with-template-expressions "Permanent link")
...
#### Expression Format with JavaScript Evaluation[¶](https://microsoft.github.io/poml/stable/language/meta/#expression-format-with-javascript-evaluation "Permanent link")
...
The expression can return either: - A Zod schema object (detected by the presence of `_def` property) - A plain JavaScript object treated as JSON Schema

**Important limitations:** - Only one `output-schema` element is allowed per document. Multiple response schemas will result in an error.

### Tool Registration[¶](https://microsoft.github.io/poml/stable/language/meta/#tool-registration "Permanent link")
...
#### JSON Schema Format[¶](https://microsoft.github.io/poml/stable/language/meta/#json-schema-format_1 "Permanent link")
...
#### Expression Format[¶](https://microsoft.github.io/poml/stable/language/meta/#expression-format_1 "Permanent link")
...
#### Expression Evaluation in Tool Schemas[¶](https://microsoft.github.io/poml/stable/language/meta/#expression-evaluation-in-tool-schemas "Permanent link")

Tool schemas support the same evaluation modes as response schemas:

#### JSON with Template Expressions[¶](https://microsoft.github.io/poml/stable/language/meta/#json-with-template-expressions "Permanent link")
...
#### Expression Format[¶](https://microsoft.github.io/poml/stable/language/meta/#expression-format_2 "Permanent link")
...
**Required attributes for tools:** - **name**: Tool identifier (required) - **description**: Tool description (optional but recommended) - **parser**: Schema parser, either "json" or "eval" (optional, auto-detected based on content)

#### Template Expressions in Attributes[¶](https://microsoft.github.io/poml/stable/language/meta/#template-expressions-in-attributes "Permanent link")
...
### Runtime Parameters[¶](https://microsoft.github.io/poml/stable/language/meta/#runtime-parameters "Permanent link")

Runtime parameters configure the language model's behavior during execution. These parameters are automatically used in [VSCode's test command](https://microsoft.github.io/poml/stable/vscode/features/) functionality, which is based on the [Vercel AI SDK](https://ai-sdk.dev/).
...
#### Key Conversion[¶](https://microsoft.github.io/poml/stable/language/meta/#key-conversion "Permanent link")
...
#### Value Conversion[¶](https://microsoft.github.io/poml/stable/language/meta/#value-conversion "Permanent link")
...
#### Common Parameters[¶](https://microsoft.github.io/poml/stable/language/meta/#common-parameters "Permanent link")
