# Template Engine
_Estimated time to read: 5 minutes_

The template engine of POML allows you to incorporate dynamic content and control structures. Here are some key features.

Expressions[¶](https://microsoft.github.io/poml/stable/language/template/#expressions "Permanent link")
-------------------------------------------------------------------------------------------------------
...
### Usage in Attributes[¶](https://microsoft.github.io/poml/stable/language/template/#usage-in-attributes "Permanent link")
...
### Expression Usages[¶](https://microsoft.github.io/poml/stable/language/template/#expression-usages "Permanent link")
...
Let Expressions[¶](https://microsoft.github.io/poml/stable/language/template/#let-expressions "Permanent link")
---------------------------------------------------------------------------------------------------------------

The `<let>` tag allows you to define variables, import data from external files, and set values within your POML template.

### Syntax 1: Setting a variable from a value[¶](https://microsoft.github.io/poml/stable/language/template/#syntax-1-setting-a-variable-from-a-value "Permanent link")
...
### Syntax 2: Importing data from a file[¶](https://microsoft.github.io/poml/stable/language/template/#syntax-2-importing-data-from-a-file "Permanent link")
...
### Syntax 3: Importing data from a file without a name[¶](https://microsoft.github.io/poml/stable/language/template/#syntax-3-importing-data-from-a-file-without-a-name "Permanent link")
...
### Syntax 4: Setting a variable using inline JSON[¶](https://microsoft.github.io/poml/stable/language/template/#syntax-4-setting-a-variable-using-inline-json "Permanent link")
...
### Syntax 5: Setting a variable from an expression[¶](https://microsoft.github.io/poml/stable/language/template/#syntax-5-setting-a-variable-from-an-expression "Permanent link")
...
Type-Autocasting in Attributes[¶](https://microsoft.github.io/poml/stable/language/template/#type-autocasting-in-attributes "Permanent link")
---------------------------------------------------------------------------------------------------------------------------------------------
...
For Attribute[¶](https://microsoft.github.io/poml/stable/language/template/#for-attribute "Permanent link")
-----------------------------------------------------------------------------------------------------------
...
### Loop Variables[¶](https://microsoft.github.io/poml/stable/language/template/#loop-variables "Permanent link")
...
If Condition[¶](https://microsoft.github.io/poml/stable/language/template/#if-condition "Permanent link")
---------------------------------------------------------------------------------------------------------
...
Include Files[¶](https://microsoft.github.io/poml/stable/language/template/#include-files "Permanent link")
-----------------------------------------------------------------------------------------------------------
