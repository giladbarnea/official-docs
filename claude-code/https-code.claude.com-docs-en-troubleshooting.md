...
URL Source: http://code.claude.com/docs/en/troubleshooting
...
For additional JetBrains configuration tips, see our [IDE integration guide](https://code.claude.com/docs/en/vs-code#jetbrains-plugin-settings).
