...
URL Source: http://code.claude.com/docs/en/sdk/migration-guide
...
**5. Review [breaking changes](http://code.claude.com/docs/en/sdk/migration-guide#breaking-changes)**Make any code changes needed to complete the migration.
...
See the [Troubleshooting](https://code.claude.com/docs/en/troubleshooting) guide for common issues.
