...
Create .claude-plugin/plugin.json Copy Ask AI
...
Create commands/hello.md Copy Ask AI
...
Create marketplace.json Copy Ask AI
...
Start Claude Code from parent directory Copy Ask AI
...
Add the test marketplace Copy Ask AI

```
/plugin marketplace add ./test-marketplace
```

Install your plugin Copy Ask AI
...
Try your new command Copy Ask AI
...
Add a marketplace Copy Ask AI

```
/plugin marketplace add your-org/claude-plugins
```

Browse available plugins Copy Ask AI
...
Open the plugin management interface Copy Ask AI
...
Install a specific plugin Copy Ask AI

```
/plugin install formatter@your-org
```

Enable a disabled plugin Copy Ask AI

```
/plugin enable plugin-name@marketplace-name
```

Disable without uninstalling Copy Ask AI

```
/plugin disable plugin-name@marketplace-name
```

Completely remove a plugin Copy Ask AI
...
Create directory structure Copy Ask AI
...
Add your development marketplace Copy Ask AI
...
Uninstall the current version Copy Ask AI

```
/plugin uninstall my-plugin@dev-marketplace
```

Reinstall to test changes Copy Ask AI
...
[Subagents](/docs/en/sub-agents) [Agent Skills](/docs/en/skills) ⌘ I