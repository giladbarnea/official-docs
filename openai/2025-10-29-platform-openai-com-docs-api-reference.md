...
[Introduction](https://platform.openai.com/docs/api-reference/introduction?api-mode=responses)

[Authentication](https://platform.openai.com/docs/api-reference/authentication?api-mode=responses)

[Debugging requests](https://platform.openai.com/docs/api-reference/debugging-requests?api-mode=responses)

[Backward compatibility](https://platform.openai.com/docs/api-reference/backward-compatibility?api-mode=responses)

Responses API

[Responses](https://platform.openai.com/docs/api-reference/responses?api-mode=responses)

[Create a model response](https://platform.openai.com/docs/api-reference/responses/create?api-mode=responses)

[Get a model response](https://platform.openai.com/docs/api-reference/responses/get?api-mode=responses)

[Delete a model response](https://platform.openai.com/docs/api-reference/responses/delete?api-mode=responses)

[Cancel a response](https://platform.openai.com/docs/api-reference/responses/cancel?api-mode=responses)

[List input items](https://platform.openai.com/docs/api-reference/responses/input-items?api-mode=responses)

[Get input token counts](https://platform.openai.com/docs/api-reference/responses/input-tokens?api-mode=responses)

[The response object](https://platform.openai.com/docs/api-reference/responses/object?api-mode=responses)

[The input item list](https://platform.openai.com/docs/api-reference/responses/list?api-mode=responses)

[Conversations](https://platform.openai.com/docs/api-reference/conversations?api-mode=responses)

[Videos](https://platform.openai.com/docs/api-reference/videos?api-mode=responses)

[Streaming events](https://platform.openai.com/docs/api-reference/responses-streaming?api-mode=responses)

Webhooks

[Webhook Events](https://platform.openai.com/docs/api-reference/webhook-events?api-mode=responses)

Platform APIs

[Audio](https://platform.openai.com/docs/api-reference/audio?api-mode=responses)

[Images](https://platform.openai.com/docs/api-reference/images?api-mode=responses)

[Image Streaming](https://platform.openai.com/docs/api-reference/images-streaming?api-mode=responses)

[Embeddings](https://platform.openai.com/docs/api-reference/embeddings?api-mode=responses)

[Evals](https://platform.openai.com/docs/api-reference/evals?api-mode=responses)

[Fine-tuning](https://platform.openai.com/docs/api-reference/fine-tuning?api-mode=responses)

[Graders](https://platform.openai.com/docs/api-reference/graders?api-mode=responses)

[Batch](https://platform.openai.com/docs/api-reference/batch?api-mode=responses)

[Files](https://platform.openai.com/docs/api-reference/files?api-mode=responses)

[Uploads](https://platform.openai.com/docs/api-reference/uploads?api-mode=responses)

[Models](https://platform.openai.com/docs/api-reference/models?api-mode=responses)

[Moderations](https://platform.openai.com/docs/api-reference/moderations?api-mode=responses)

Vector stores

[Vector stores](https://platform.openai.com/docs/api-reference/vector-stores?api-mode=responses)

[Vector store files](https://platform.openai.com/docs/api-reference/vector-stores-files?api-mode=responses)

[Vector store file batches](https://platform.openai.com/docs/api-reference/vector-stores-file-batches?api-mode=responses)

ChatKit

Beta

[ChatKit](https://platform.openai.com/docs/api-reference/chatkit?api-mode=responses)

Containers

[Containers](https://platform.openai.com/docs/api-reference/containers?api-mode=responses)

[Container Files](https://platform.openai.com/docs/api-reference/container-files?api-mode=responses)

Realtime

[Realtime](https://platform.openai.com/docs/api-reference/realtime?api-mode=responses)

[Client secrets](https://platform.openai.com/docs/api-reference/realtime-sessions?api-mode=responses)

[Calls](https://platform.openai.com/docs/api-reference/realtime-calls?api-mode=responses)

[Client events](https://platform.openai.com/docs/api-reference/realtime-client-events?api-mode=responses)

[Server events](https://platform.openai.com/docs/api-reference/realtime-server-events?api-mode=responses)

Chat Completions

[Chat Completions](https://platform.openai.com/docs/api-reference/chat?api-mode=responses)

[Streaming](https://platform.openai.com/docs/api-reference/chat-streaming?api-mode=responses)

Assistants

Beta

[Assistants](https://platform.openai.com/docs/api-reference/assistants?api-mode=responses)

[Threads](https://platform.openai.com/docs/api-reference/threads?api-mode=responses)

[Messages](https://platform.openai.com/docs/api-reference/messages?api-mode=responses)

[Runs](https://platform.openai.com/docs/api-reference/runs?api-mode=responses)

[Run steps](https://platform.openai.com/docs/api-reference/run-steps?api-mode=responses)

[Streaming](https://platform.openai.com/docs/api-reference/assistants-streaming?api-mode=responses)

Administration

[Administration](https://platform.openai.com/docs/api-reference/administration?api-mode=responses)

[Admin API Keys](https://platform.openai.com/docs/api-reference/admin-api-keys?api-mode=responses)

[Invites](https://platform.openai.com/docs/api-reference/invite?api-mode=responses)

[Users](https://platform.openai.com/docs/api-reference/users?api-mode=responses)

[Projects](https://platform.openai.com/docs/api-reference/projects?api-mode=responses)

[Project users](https://platform.openai.com/docs/api-reference/project-users?api-mode=responses)

[Project service accounts](https://platform.openai.com/docs/api-reference/project-service-accounts?api-mode=responses)

[Project API keys](https://platform.openai.com/docs/api-reference/project-api-keys?api-mode=responses)

[Project rate limits](https://platform.openai.com/docs/api-reference/project-rate-limits?api-mode=responses)

[Audit logs](https://platform.openai.com/docs/api-reference/audit-logs?api-mode=responses)

[Usage](https://platform.openai.com/docs/api-reference/usage?api-mode=responses)

[Certificates](https://platform.openai.com/docs/api-reference/certificates?api-mode=responses)

Legacy

[Completions](https://platform.openai.com/docs/api-reference/completions?api-mode=responses)

[Realtime Beta](https://platform.openai.com/docs/api-reference/realtime_beta?api-mode=responses)

[Realtime Beta session tokens](https://platform.openai.com/docs/api-reference/realtime-beta-sessions?api-mode=responses)

[Realtime Beta client events](https://platform.openai.com/docs/api-reference/realtime-beta-client-events?api-mode=responses)

[Realtime Beta server events](https://platform.openai.com/docs/api-reference/realtime-beta-server-events?api-mode=responses)
