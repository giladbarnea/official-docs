...
After achieving feature parity in the Responses API, we've deprecated the Assistants API. It will shut down on August 26, 2026. Follow the [migration guide](/docs/assistants/migration) to update your integration. [Learn more](/docs/guides/responses-vs-chat-completions).
